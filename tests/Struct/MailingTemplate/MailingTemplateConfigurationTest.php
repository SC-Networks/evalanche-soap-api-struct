...
class MailingTemplateConfigurationTest extends StructTestCase
{
    /**
     * @var MailingTemplateConfiguration
     */
    private $subject;

    public function setUp(): void
    {
        $this->subject = new MailingTemplateConfiguration();
    }
    ...
    public function testGetContainerTypeCanReturnString(): void
    {
        self::assertSame('some container type', $this->subject->setContainerType('some container type')->getContainerType());
    }
}
